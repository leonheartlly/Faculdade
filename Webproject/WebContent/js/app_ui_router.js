...
myApp.config(function($stateProvider, $urlRouterProvider) {
	...
	}).state('cadastro-cliente.list', {
		url : "/list",
		templateUrl : "pages/cadastro-cliente.list.html",
		controller : function($scope) {
			$scope.items = [ "João", "Maria", "José", "Antônia" ];
		}
	}).state('cadastro-veiculo', {
		url : "/cadastro-veiculo",
		templateUrl : "pages/cadastro-veiculo.html"
	}).state('cadastro-veiculo.list', {
		url : "/list",
		templateUrl : "pages/cadastro-veiculo.list.html",
		controller : function($scope) {
			$scope.things = [ "Audi", "BMW", "Mercedes", "Ferrari" ];
		}
	})
});
