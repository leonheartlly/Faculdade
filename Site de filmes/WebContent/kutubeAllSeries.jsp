...
<body>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown active"><a href="#"
							...
							aria-haspopup="true" aria-expanded="false">Todos<span
								class="caret"></span></a>
	...
	<div class="container marketing">
		<div class="row">
			...
			<div class="col-lg-16">
				<img class="img-circle" src="images/banner2	.jpg"
					alt="Generic placeholder image" width="140" height="140">
				<h1>Game of Thrones</h1>
				<p>Game of Thrones se passa em Westeros, uma terra reminiscente
					da Europa Medieval, onde as estações duram por anos ou até mesmo
					décadas. A história gira em torno de uma batalha entre os Sete
					Reinos, onde duas famílias dominantes estão lutando pelo controle
					do Trono de Ferro, cuja posse assegura a sobrevivência durante o
					inverno de 40 anos que está por vir.</p>
				<p>
	...
	<footer>
	<p class="pull-right">
		<a href="#"> <i class="glyphicon glyphicon-chevron-up"></i> Back
			to top
		</a>
	</p>
	<p>
	...
	<%
		System.out.println("KuTube Series");
	%>
